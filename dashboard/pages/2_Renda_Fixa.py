...
from dashboard.dados import carregar_dados_rf, obter_valores_titulo, obter_resgates_titulo
...
with st.sidebar:
    ...
    id_titulo = st.selectbox("ID do título", ["Selecionar"] + renda_fixa_df.index.tolist())
...
if id_titulo == "Selecionar":
    ...
    titulo_selecionado = df_rf_formatado.loc[df_rf_formatado["ID"].eq(id_titulo), :].iloc[0]
