...
from src.dashboard.formatacao import formatar_df_proventos, formatar_dinheiro, formatar_df_proventos_ativo
from src.dashboard.graficos import plotar_proventos

def pagina_proventos(proventos: pd.DataFrame):
    with st.sidebar:
        periodo = st.selectbox("Período", ["6 meses", "1 ano", "2 anos", "Personalizado"])
